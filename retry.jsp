...
<html>
<head>
    <meta http-equiv="refresh" content="5; url=https://localhost:9443/oauth2/authorize?response_type=code&client_id=OZfb2icUEXehApXC8UCaMlHwFXYa&redirect_uri=https://invexluiss.modyo.cloud/loginunico/jwt&scope=openid FolioInternet,CUI,CodigoAplicacion">
    <!-- header -->
    <%
